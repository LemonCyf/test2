...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<%
		...
		request.setAttribute("returnOid",returnOid);
		request.setAttribute("returnPay",returnPay);
	...
	<div id="main">
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${requestScope.oid}"/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${requestScope.name}的订单"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${requestScope.pay}" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
		...
		<form name=traderefund action="${pageContext.request.contextPath}/returnMoney" method=post
			target="_blank">
			<div id="body3" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTRout_trade_no" name="WIDTRout_trade_no" value="${requestScope.returnOid}" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
					...
					<dt>退款金额 ：</dt>
					<dd>
						<input id="WIDTRrefund_amount" name="WIDTRrefund_amount" value="${requestScope.returnPay}"/>
					</dd>
					<hr class="one_line">
					<dt>退款原因 ：</dt>
					<dd>
