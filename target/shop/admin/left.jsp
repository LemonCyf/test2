...
<div class="dtree" >
	...
	<script type="text/javascript">
		...
		d.add('010201','0102','展示所有分类','${pageContext.request.contextPath}/adminGetAll?clean=no','','mainFrame');
        d.add('010202','0102','添加分类','${pageContext.request.contextPath}/admin/category/add.jsp','','mainFrame');
        //d.add('010203','0102','修改分类','${pageContext.request.contextPath}/adminGetById','','mainFrame');
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/adminProduct_findAll?currPage=0','','mainFrame');
