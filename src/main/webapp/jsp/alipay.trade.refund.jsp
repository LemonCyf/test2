...
<%@ page import="com.zjitc.config.AlipayConfig" %>
<%@ page import="com.google.gson.Gson" %>
<%@ page import="com.zjitc.domain.AlipayRefund" %>
<%@ page import="com.zjitc.domain.AResponse" %>
<%
	//获得初始化的AlipayClient
	...
	Gson gson = new Gson();
	AlipayRefund alipayRefund1 = gson.fromJson(result, AlipayRefund.class);
	AResponse alipayTradeRefundResponse = alipayRefund1.getAlipayTradeRefundResponse();
	String msg = alipayTradeRefundResponse.getMsg();
	request.setAttribute("msg",msg);
	request.getRequestDispatcher("/returnMoney").forward(request,response);
	//输出
	//out.println(result);
%>
<body>
